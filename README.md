# 🎉 questionable-fyi - Ask Questions, Get Answers Easily
...
3. **Installation**  
   After downloading the file, follow these installation steps based on your operating system:
   ...
   - Open a terminal.
   - Use the command `chmod +x <file_name>` to make the downloaded file executable.
   - Run the command `./<file_name>` to start the installation.

   ### 🍏 macOS
   - Find the downloaded file in your Downloads folder.
   - Double-click the `.dmg` file.
   - Drag the Questionable icon to your Applications folder.

4. **Launching Questionable**  
   After installation, locate Questionable in your applications. Click to launch the app and start asking questions!

## 📊 Features
- **User-Friendly Interface**  
  Navigate easily and access features without technical knowledge.

- **Real-Time Responses**  
  Get answers quickly from other users.

- **Interview Functionality**  
  Set up and conduct interviews or AMAs effortlessly.

- **Notifications**  
  Stay updated with notifications on questions and answers.

## ⚙️ System Requirements
To run Questionable smoothly, make sure your system meets these requirements:

- **Windows**: Windows 10 or later. 
- **macOS**: macOS 10.15 or later. 
- **Linux**: Any modern distribution.

Ensure you have at least 500 MB of free disk space and a stable internet connection to use Questionable effectively.
